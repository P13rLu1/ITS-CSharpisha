...
internal class Studente
{
    ...
    internal string? Cognome { get; private set; }
    internal DateOnly DataDiNascita { get;}
    internal string? Classe { get; private set; }
    internal int Id { get;}

    private Studente(string? nome, string? cognome, DateOnly dataDiNascita, string? classe)
    {
        Nome = nome;
        Cognome = cognome;
