...
namespace BigliettApp.ConsoleApp.Controllers
{
    internal class MenuController
    {
        ...
        private SpettacoloController _tavoloController;
        private PrenotazioneController _prenotazioneController;
        
        public MenuController(ClienteController clienteController, SpettacoloController tavoloController, PrenotazioneController prenotazioneController)
        {
        ...
        public void Menu()
        {
            ...
            do
            {
                ...
                Console.Write("[2] Gestisci spettacolo | ");
